...
if (!nv_function_exists('nv_menu_theme_social_footer')) {
    /**
     * nv_menu_theme_social_footer_config()
     *
     * @param string $module
     ...
     * @return string
     */
    function nv_menu_theme_social_footer_config($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_menu_theme_social_footer_submit()
     *
     * @param string $module
     * @param array  $lang_block
     * @return array
     */
    function nv_menu_theme_social_footer_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
    ...
    /**
     * nv_menu_theme_social_footer()
     *
     * @param array $block_config
     * @return string
     */
    function nv_menu_theme_social_footer($block_config)
    {
        global $global_config, $site_mods, $lang_global;

        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.social_footer.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.social_footer.tpl')) {
            $block_theme = $global_config['site_theme'];
        } else {
            $block_theme = 'default';
        }

        $xtpl = new XTemplate('global.social_footer.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
...
if (defined('NV_SYSTEM')) {
    $content = nv_menu_theme_social_footer($block_config);
}
