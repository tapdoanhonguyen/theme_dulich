...
function nv_site_theme($contents, $full = true)
{
    ...
    if ($global_config['current_theme_type'] == 'r') {
		...
		$html_links[] = [
            'rel' => 'stylesheet',
            'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/css/slick.css'
        ];
		$html_links[] = [
            'rel' => 'stylesheet',
            'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/css/slick.min.css'
        ];
		$html_links[] = [
            'rel' => 'stylesheet',
            'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/css/slick-theme.css'
        ];
    } else {
        $html_links[] = [
            'rel' => 'stylesheet',
	...
	$html_js[] = [
        'ext' => 1,
        'content' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/js/slick.min.js'
    ];
	$html_js[] = [
        'ext' => 1,
        'content' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/js/slick-slider.js'
    ];
